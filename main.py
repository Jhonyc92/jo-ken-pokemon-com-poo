...
# Definindo uma classe chamada "JogoJoKenPokemon" para 
# encapsular a lógica e estado do jogo.
class JogoJoKenPokemon:
    ...
    def __init__(self):
        ...
        self.escolhas = ['Pedra', 'Papel', 'Tesoura', 'Corda', 'Água', 'Fogo']
    ...
    def obter_escolha_jogador(self):
        ...
        escolha = int(input("Escolha sua opção (1 a 6): "))
    ...
    def determinar_vencedor(self, escolha_jogador, escolha_computador):
        ...
        regras = {
            'Pedra': {'vence': ['Tesoura', 'Água'], 'razao': ['ganha', 'ganha']},
            'Papel': {'vence': ['Pedra', 'Corda'], 'razao': ['ganha', 'ganha']},
            'Tesoura': {'vence': ['Papel', 'Corda'], 'razao': ['ganha', 'ganha']},
            'Corda': {'vence': ['Pedra'], 'razao': ['ganha']},
            'Água': {'vence': ['Fogo', 'Corda', 'Papel', 'Tesoura'], 'razao': ['ganha', 'ganha', 'ganha', 'ganha']},
            'Fogo': {'vence': ['Papel', 'Tesoura', 'Corda', 'Pedra'], 'razao': ['ganha', 'ganha', 'ganha', 'ganha']}
        }
    ...
    def exibir_pontuacao(self):
        ...
        print(f"Pontuação: Você - {self.pontuacao_jogador} x {self.pontuacao_computador} - Computador")
    ...
    def jogar(self):
        ...
        print("Bem-vindo ao Jogo Jo Ken Pokémon!")
...
if __name__ == "__main__":
    ...
    # Cria um objeto 'jogo' da classe 'JogoJoKenPokemon' (inicializa uma nova instância do jogo).
    jogo = JogoJoKenPokemon()
